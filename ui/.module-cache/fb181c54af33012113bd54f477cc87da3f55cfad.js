...
var CommentForm = React.createClass({displayName: "CommentForm",
        ...
        if(this.refs.needsPhoto){
            return(
                React.createElement("div", {className: "commentForm"}, 
                    React.createElement(Dropzone, {style: {width:"100%", height:"80px", border:"dashed"}, onPhotoDrop: this.onDrop}, "Drag and drop a file, or just click")
                )
            );
        }
        else {
    ...
    onPhotoDrop: function(droppedFiles){
        ...
        this.forceUpdate();
        var widget = this;
        fileUpload(this.props.baseUrl+"/photos", droppedFiles[0], function(resp){
